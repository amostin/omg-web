    ...
    render() {
        return (
            <div className="card mb-4">
                ...
                <a href="#collapseCardExample" className="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                    <h6 className="m-0 font-weight-bold text-primary">{this.state.title}</h6>
                </a>
                {/* <!-- Card Content - Collapse --> */}
                <div className="collapse collapsed" id="collapseCardExample">
